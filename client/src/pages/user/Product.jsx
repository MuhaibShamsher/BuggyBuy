...
export default function ProductPage() {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_API_URL}/products/reviews/${productId}`, {
        method: 'POST',
        headers: {
      ...
      // Refresh product
      const updatedRes = await fetch(`${import.meta.env.VITE_API_URL}/products/${productId}`);
